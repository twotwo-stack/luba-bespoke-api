...
export async function GET(req: NextRequest) {
  ...
  let query = supabase
    .from('partners')
    .select('id, created_at, name, email, phone, active, business_name, slug, subscription_tier, notes', { count: 'exact' })
...
export async function PATCH(req: NextRequest) {
  ...
  const allowed = ['active', 'notes', 'subscription_tier']
  ...
  await logAdminAction(admin.userId, 'update_partner', 'partner', id, filtered)
